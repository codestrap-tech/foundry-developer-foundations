      ...
      .map((line, idx) => {
        ...
        return (
          <div
            key={idx}
            className={`${
              isSystem ? 'self-start' : 'self-end'
            } max-w-[80%] bg-white shadow-sm px-4 py-2 rounded-lg border border-gray-200 text-gray-800`}
          >
        ...
        <div className="h-full flex flex-col">
          <div
            className={`mt-6 flex flex-col gap-4 ${
              !getTaskListToolExecuted ? 'hidden' : ''
            }`}
          >
            {/* Status Indicator */}
            <div className="flex items-center gap-2">
              ...
              <div
                className={`w-3 h-3 rounded-full ${
                  getTaskListToolExecuted ? 'bg-green-500' : 'bg-red-500'
                }`}
              />
            </div>
          ...
          <div
            className={`mt-6 flex flex-col gap-4 ${
              !executeTaskListToolExecuted ? 'hidden' : ''
            }`}
          >
            {/* Status Indicator */}
            <div className="flex items-center gap-2">
              ...
              <div
                className={`w-3 h-3 rounded-full ${
                  executeTaskListToolExecuted ? 'bg-green-500' : 'bg-red-500'
                }`}
              />
            </div>
